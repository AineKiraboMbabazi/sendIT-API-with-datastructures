[![Build Status](https://travis-ci.com/AineKiraboMbabazi/sendIT-API-with-datastructures.svg?branch=challenge-s3)](https://travis-ci.com/AineKiraboMbabazi/sendIT-API-with-datastructures)
