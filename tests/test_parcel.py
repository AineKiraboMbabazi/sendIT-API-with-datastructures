...
# from sendapi.models import users, User, parcels, Parcel
# from sendapi.controller import reset_users, reset_parcels, AppController
...
#     #     self.assertIsNotNone(self.AppController.get_parcels())

#     # def test_model_can_fetch_all_parcels_as_a_list(self):

#     #     self.assertIsInstance(self.AppController.get_parcels(), dict)
...
#     #     self.assertIsInstance(self.AppController.get_specific_parcel(1), dict)
#     #     self.assertEqual(self.AppController.get_specific_parcel(100000000000), {
...
#     #         self.AppController.get_parcels_by_specific_user(1), dict)
#     #     self.assertIsNotNone(self.AppController.get_parcels_by_specific_user(1))
...
#     #     self.assertIsNotNone(self.AppController.cancel_specific_parcel(1))
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(
#     #         1), {"message": "The order you are trying to cancel doesnot exist"})
#     #     self.assertIsInstance(self.AppController.cancel_specific_parcel(1), dict)
...
#     #         self.AppController.cancel_specific_parcel(1)[1]['destination'])
#     #     self.assertIsNotNone(
#     #         self.AppController.cancel_specific_parcel(1)[1]['pickup'])
#     #     self.assertIsNotNone(
#     #         self.AppController.cancel_specific_parcel(1)[1]['status'])
#     #     self.assertIsNotNone(
#     #         self.AppController.cancel_specific_parcel(1)[1]['userId'])
#     #     self.assertIsNotNone(
#     #         self.AppController.cancel_specific_parcel(1)[1]['parcelId'])
#     #     self.assertIsNotNone(self.AppController.cancel_specific_parcel(1)[
#     #                          1]['creation_date'])
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(1)[
#     #                      1]['destination'], 'Arua')
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(1)[
#     #                      1]['pickup'], 'Masaka')
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(1)[
#     #                      1]['status'], 'canceled')
#     #     self.assertEqual(
#     #         self.AppController.cancel_specific_parcel(1)[1]['userId'], 2)
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(1)[
#     #                      1]['parcelId'], 1)
#     #     self.assertEqual(self.AppController.cancel_specific_parcel(1)[
...
#     #     self.assertEqual(self.AppController.auto_increment_id(), 1)

#     # def test_auto_increment_id_parcels(self):
#     #     self.assertEqual(self.AppController.auto_increment_id(), 1)

#     # def test_get_users(self):
#     #     self.assertEqual(self.AppController.get_users(), {
#     #                      "message": "No users have been created"})
#     #     self.assertIsInstance(self.AppController.get_users(), dict)
#     #     newuser = {
